...
def cvt(id: str|int, tgt: str) -> str|int:
    ...
    if tgt == "STEAMID2":
        account_id = int(id64) - ID64_MAGIC_NUMBER
        y = account_id % 2
        z = (account_id - y) // 2
        return f"STEAM_0:{y}:{z}"
    elif tgt == "STEAMID3-N":
        return int(id64) - ID64_MAGIC_NUMBER
    elif tgt == "STEAMID3-B":
        return f"[U:1:{int(id64) - ID64_MAGIC_NUMBER}]"
    elif tgt == "STEAMID64":
        return int(id64)
    else:
        return None
